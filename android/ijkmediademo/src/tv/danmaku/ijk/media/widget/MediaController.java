...
import com.ntian.videoplayer.R;
import com.ntian.videoplayer.VideoPlayerActivity;
...
public class MediaController extends FrameLayout {
	...
	private GestureDetector mWindowGestureDetector;
	private VideoPlayerActivity myVideoPlayerActivity;
	...
	private boolean initController(Context context) {
		...
		mWindowGestureDetector = new GestureDetector(context,
				new MyWindowGestureDetectorListener());
		myVideoPlayerActivity = (VideoPlayerActivity) context;
		...
		Log.e(TAG, "mDisPlayMetrics---------->>>>>" + Screen_Width + ":::::"
				+ Screen_Height);
		return true;
	}
	...
	protected View makeControllerView() {
		return ((LayoutInflater) mContext
				...
				R.layout.activity_media_controler, this);
	}
	...
	private void initControllerView(View v) {
		...
		mBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Message message = myHandler.obtainMessage(Activity_Back);
			...
			if (mFromXml) {
				...
				mRoot.setOnTouchListener(new OnTouchListener() {
					...
					public boolean onTouch(View v, MotionEvent event) {
						...
						mWindowGestureDetector.onTouchEvent(event);
						Log.e(TAG,
								"mWindowGestureDetector------"
										+ event.getAction());
	...
	class MyGestureDetectorListener extends
	...
	class MyWindowGestureDetectorListener extends
			GestureDetector.SimpleOnGestureListener {
		...
		public boolean onScroll(MotionEvent e1, MotionEvent e2,
			...
			if (e1.getRawX() < (Screen_Width / 2)) {

				if (e2.getRawX() > (Screen_Width / 2)) {
					Log.e(TAG, "右边------------>>>>>>>>>" + distanceY);
					myVideoPlayerActivity.setBright(distanceY);

				} else {
					Log.e(TAG, "左边------------>>>>>>>>>" + distanceY);
					myVideoPlayerActivity.setSound(distanceY);
				}
	...
	public boolean onTrackballEvent(MotionEvent ev) {
		Log.e(TAG, "onTrackballEvent--------->>>>>>" + ev.getAction());
		show(sDefaultTimeout);
		return false;
	}
