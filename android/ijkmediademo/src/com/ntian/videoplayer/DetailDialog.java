...
import com.ntian.videoplayer.MoviesContentAcitivity.ViewHolder;

public class DetailDialog extends AlertDialog implements
	...
	public DetailDialog(final Context context,
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (mView != null) {
			...
			mTitleView.setText(mContext.getString(R.string.detail_title,
					mHolder.mTitle));
			mPathView.setText(mContext.getString(R.string.detail_path,
					mHolder.mData));
